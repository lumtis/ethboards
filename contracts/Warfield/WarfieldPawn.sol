...
// Player A controls white pawns, pawn from 0 to 3
// Player B controls white pawns, pawn from 4 to 7
contract WarfieldPawn {
    ...
    function isSoldierOrBazooka(
        ...
        return (pawnType == 1 || pawnType == 2 || pawnType == 5 || pawnType == 6);
    }
