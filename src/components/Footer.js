...
class Footer extends Component {
  ...
  termsOfUse(e) {
    ...
    <div style={{height: '400px', overflowY: 'scroll'}}>
      <h3 style={{color: '#8559A5'}}>1. Terms</h3>
      ...
      <h3 style={{color: '#8559A5'}}>2. Use License</h3>
      ...
      <h3 style={{color: '#8559A5'}}>3. Disclaimer</h3>
      ...
      <h3 style={{color: '#8559A5'}}>4. Limitations</h3>
      ...
      <h3 style={{color: '#8559A5'}}>5. Accuracy of materials</h3>
      ...
      <h3 style={{color: '#8559A5'}}>6. Links</h3>
      ...
      <h3 style={{color: '#8559A5'}}>9. Modifications</h3>
